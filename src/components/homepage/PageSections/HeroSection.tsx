...
export default async function HeroSection() {
  ...
  return (
    <article className="relative w-full py-[15vh] lg:py-[7vh] ">
      <div className="mb-12 animate-fadeIn lg:mb-8 flex w-full flex-col items-center justify-center space-y-12 lg:space-y-6 align-middle ">
        <h1 className="w-full animate-fadeIn max-w-[350px] text-center  font-handwriting text-5xl text-cyan-900   lg:max-w-[450px] lg:text-6xl  ">
          {hydrationData.title}
        </h1>
        <h2 className="max-w-[300px] text-center font-serif text-xl font-thin lg:max-w-[550px] lg:font-light ">
      ...
      <div className="mt-20 animate-fadeIn flex w-full flex-col items-center lg:items-baseline ">
        <div className="w-[95vw] rounded-3xl bg-cyan-100 px-2 py-4 text-xl shadow-md shadow-stone-300 lg:ml-[2vw] lg:w-auto lg:max-w-[60vw]">
